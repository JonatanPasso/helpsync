...
class ArmazemController extends Controller
{
    ...
    public function salvar(Request $request)
    {
        ...
        if ((int)$request->input('id')) {
            $registro = Armazem::where('id', (int)$request->id)->firstOrFail();
        } else {
            $registro = new Armazem();
            $registro->estoque_id = (int)$request->estoque_id;
    ...
    public function excluir(Request $req)
    {
        ...
        $registro = Armazem::where('id', (int)$req->id)->first();
...
//            }
    ...
    public function buscar(Request $req)
    {
        ...
        if ($req->input('filtro.estoque_id')) {
            $query->where('estoque_id', $req->input('filtro.estoque_id'));
        }
