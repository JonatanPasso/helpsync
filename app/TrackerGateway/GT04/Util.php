...
abstract class Util
{
    ...
    public static function bytesToHex(array $bytes)
    {
        ...
        foreach ($bytes as $i => $v) {
            $string .= str_pad(dechex($v), 2, '0', STR_PAD_LEFT);
        }
        return $string;
    }

    public static function usingedBytesToInt(array $array)
    {
        return ($array[0] << 8) + $array[1];
    }

    public static function desagrupar_msgs(array $array)
    {
        $n = 0;
        $t = [];
        ...
        if (count($array) > 0) {
            ...
            for ($i = 0; $i < count($array); $i++) {
                ...
                if ($array[$i] == 0x78 && $array[$i + 1] == 0x78) {
                    $n++;
                }
                $t[$n][] = $array[$i];
            }
