<template>
    <b-card>
        <template #header>
            <span class="text-info"><i class="fa fa-table"></i> Linhas de Produtos Cadastradas</span>
        </template>
...
export default {
    ...
    data() {
        return {
            campos: [
                {label: 'Código', key: 'id', sortable: 1},
                {label: 'Marca', key: 'marca.nome'},
                {label: 'Linha', key: 'nome', sortable: 1},
            ],
