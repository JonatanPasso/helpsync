<template>
    ...
    <div>
        <Card class="print-hide">
            <template #header>
                <i class="fa fa-chart-area"></i> Relatório de Quilometragem
            </template>
                        ...
                        <b-overlay :show="ajaxStatus"
                            ...
                            <b-table bordered hover
                                ...
                                <template #bottom-row>
                                    ...
                                    <b-td align="left" variant="warning">{{total}} KM</b-td>
                                </template>
                            </b-table>
                        </b-overlay>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            gerarRelatorio() {
                this.doGet('relatorio/telemetria/kilometragem', this.filtro)
                    .then((result) => {
